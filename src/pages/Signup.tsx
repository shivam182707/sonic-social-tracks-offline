...
const Signup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-spotify-black to-spotify-dark">
      <div className="flex justify-center p-6">
        <svg viewBox="0 0 1134 340" className="h-12 text-white">
          <title>Beatify</title>
          ...
          <div className="bg-spotify-darkgray rounded-lg p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-spotify-lightgray h-5 w-5" />
                  <Input
                    type="email"
                    id="email"
                    value={email}
              ...
              <div className="mb-6">
                <label htmlFor="password" className="block text-sm font-medium text-spotify-lightgray mb-1">
                  Password
                </label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-spotify-lightgray h-5 w-5" />
                  <Input
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-spotify-lightgray"
                  >
                    {showPassword ? (
      ...
      <footer className="p-6 text-center text-spotify-lightgray text-xs">
        <p>© 2025 Beatify Music Platform</p>
      </footer>
    </div>
  );
};

          ...
          <div className="bg-spotify-darkgray rounded-lg p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded bg-[#333] text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-spotify-green"
                  required
                />
            ...
            <div className="mt-6 text-center">
              <p className="text-spotify-lightgray">
                ...
                <button className="text-white underline ml-1">
                  Sign up for Beatify
                </button>
              </p>
            </div>
